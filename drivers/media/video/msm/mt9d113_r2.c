...
static svreg_ctrl_t svregs[CAMV_MAX] = {
	{CAMV_IO_1P8V,   "8901_lvs1", NULL, 1800}, /* I2C pull-up */
	{CAMV_CORE_1P8V, "8901_mvs0", NULL, 1800},
	{CAMV_A_2P8V,    "8058_l9",   NULL, 2800},
};


#elif (defined(CONFIG_MACH_MSM8X60_EF40S) && (BOARD_REV >= WS20)) || \
...
static int mt9d113_set_effect(int effect)
{
	...
	case 8: pid = SI2C_EFFECT_AQUA; break;
	default:
		CERR("%s err(-EINVAL)\n", __func__);
		return -EINVAL;
	}
...
static int32_t mt9d113_set_wb(int wb)
{
	...
	switch (wb) {
	//if wb is off, it would be auto wb
	case 9:
