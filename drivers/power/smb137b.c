...
#if 0
//pz1946 20111103 compensation charging
extern int charging_stop_control;
extern int compensation_charging_restart;
#endif
...
//pz1946 20110907 EF39S EF40K EF40S OTG don't use // jcpark
#if 0 
...
#ifdef CONFIG_SKY_SMB137B_CHARGER
extern int pm8058_is_factory_cable(void);
//pz1946
		...
		int chg_voltage, int chg_current)
{
	...
	int ret = 0;
	struct smb137b_data *smb137b_chg;
//pz1946 20111115 charger interrupt change
//pr_info("~~~~~~~pz1946 smb137b_start_charging\n");
...
//pz1946 20120106 position chnage
#if 1
	ret = smb137b_write_reg(smb137b_chg->client,
...
static int smb137b_stop_charging(struct msm_hardware_charger *hw_chg)
{
	...
	struct smb137b_data *smb137b_chg;
//pz1946 20111115 charger interrupt change
//pr_info("~~~~~~pz1946 smb137b_stop_charging\n");
	smb137b_chg = container_of(hw_chg, struct smb137b_data, adapter_hw_chg);
//pz1946 20120106 tethering sleep current
