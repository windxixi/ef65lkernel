...
/* WSH, 20120. HD영상통화중 단말 reset되는 현상 수정. VIDC_1080P_ERROR_DESCRIPTOR_BUFFER_EMPTY 삭제.*/		
...
/* WSH, 20120. HD영상통화중 단말 reset되는 현상 수정. VIDC_1080P_ERROR_DESCRIPTOR_BUFFER_EMPTY 추가 */		
    case VIDC_1080P_ERROR_DESCRIPTOR_BUFFER_EMPTY:		
