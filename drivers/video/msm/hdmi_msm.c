...
static boolean msm8x60_hdmi_init = FALSE; 
#endif
...
printk("[SKY_MHL] pantech_hdmi_cable_detect : %d\n", on);
...
#ifdef CONFIG_PANTECH_FORMAT_FOR_MHL_LIMIT  // 20110429, kkcho, MHL»ç¿ëÀ» À§ÇØ HDMI OUTPUT format À» ³·Ãá´Ù... (temp´Ù )	
