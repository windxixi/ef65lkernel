...
// Has Touch Buttons
#if defined(CONFIG_SKY_EF40K_BOARD) || defined(CONFIG_SKY_EF40S_BOARD) || defined(CONFIG_SKY_EF39S_BOARD) || defined(CONFIG_SKY_EF65L_BOARD) || defined(CONFIG_PANTECH_QUANTINA_BOARD)
#define HAS_BUTTONS
#endif
