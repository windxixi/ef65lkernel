...
static struct clk_lookup msm_clocks_8x60[] = {
...
#if defined(CONFIG_EF39S_SENSORS_MPU3050) || defined(CONFIG_EF40K_SENSORS_MPU3050) || defined(CONFIG_EF40S_SENSORS_MPU3050) || defined(CONFIG_EF65L_SENSORS_MPU3050)
	...
	CLK_LOOKUP("core_clk",		gsbi5_qup_clk.c,	"qup_i2c.39"),
#else
	CLK_LOOKUP("core_clk",		gsbi5_qup_clk.c,	NULL),
#endif
#endif
...
#endif	
#if defined(CONFIG_SKY_BATTERY_MAX17040) ||  defined(CONFIG_SKY_BATTERY_MAX17043) //ps2 team shs : porting fuel gauge
...
#elif defined(CONFIG_PANTECH_CAMERA_S5K6AAFX13)
	CLK_LOOKUP("csi_clk",		csi1_clk.c, "msm_camera_s5k6aafx13.0"),
#elif defined(CONFIG_PANTECH_CAMERA_MT9V113)
