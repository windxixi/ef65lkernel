...
#if !defined(CONFIG_EF39S_SENSORS_APDS9900_SW) && !defined(CONFIG_EF40K_SENSORS_APDS9900_SW) && !defined(CONFIG_EF40S_SENSORS_APDS9900_SW) && !defined(CONFIG_EF65L_SENSORS_APDS9900_SW)
...
#endif
#if defined(CONFIG_SKY_BATTERY_MAX17040) || defined(CONFIG_SKY_BATTERY_MAX17043)  // p14682 kobj 110607
...
#endif
#if defined(CONFIG_SKY_BATTERY_MAX17040) || defined(CONFIG_SKY_BATTERY_MAX17043) //p14682 kobj 110607 PS2 TEAM SHS : guel gaue porting
	{
		.gpio = 104, // sda
		.settings = {
